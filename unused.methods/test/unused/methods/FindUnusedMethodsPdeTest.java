...
public class FindUnusedMethodsPdeTest extends PdeTestCaseWithTestProject {
	...
	private List<IMethod> calculateUnusedMethods() throws JavaModelException {
		List<IJavaProject> javaProjects = singletonList(project.asJavaProject());
		FindUnusedMethods finder = new FindUnusedMethods(javaProjects);
		finder.calculate(new NullProgressMonitor());
