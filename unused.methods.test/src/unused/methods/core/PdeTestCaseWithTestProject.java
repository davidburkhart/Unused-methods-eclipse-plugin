...
public abstract class PdeTestCaseWithTestProject {
	...
	protected Set<MethodWithBinding> calculateUnusedMethods() throws JavaModelException {
		List<IJavaElement> projects = singletonList((IJavaElement) project.asJavaProject());
